 ...
 * 展示热门视频用
 */
public class HotActivity extends BaseActivity implements OnCheckedChangeListener {
	/**
	...
	private void getDate(String id, String start) {
		...
		json ="{\n" +
                "\"list\":[\n" +
                "{\"vid\":\"1\",\"title\":\"测试\",\"content\":\"3\",\"tag\":\"4\",\"bimg\":\"5\",\"mimg\":\"6\",\"img\":\"7\",\"userId\":\"8\",\"comments\":\"9\",\"public_time\":\"10\",\"totaltime\":\"11\"},\n" +
                "]\n" +
                "}";
		/*
		Video.getHotVideo(this, id, "15", start.trim()).toString();
		*/
