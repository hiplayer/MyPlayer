...
public class TuiJianActivity extends BaseActivity implements android.widget.RadioGroup.OnCheckedChangeListener{
		...
		private void getDate(String id, String start) {
			...
			json = null;
			/*
			Video.getRecommendVideo(this, id, "30", start.trim()).toString();
			 */
